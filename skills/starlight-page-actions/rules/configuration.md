...
**type:** [`PageActionsPosition`](types#pageactionsposition.md)  
**default:** `"page-title"`
...
See the [Configure Page Actions Position guide](configure-page-actions-position.md) for more details.