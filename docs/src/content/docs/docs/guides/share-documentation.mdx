...
<Aside>
  If page actions are displayed in the table of contents, sharing options are
  not shown there because the share menu can include many options. See the
  [Configure Page Actions Position
  guide](/docs/guides/configure-page-actions-position) for details.
</Aside>
