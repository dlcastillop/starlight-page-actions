...
<Aside>
  On narrower layouts where Starlight hides the desktop table of contents, page actions are
  displayed below the page title instead.
</Aside>

<Aside>
  Sharing options are not displayed in the desktop table of contents. The share menu can include
